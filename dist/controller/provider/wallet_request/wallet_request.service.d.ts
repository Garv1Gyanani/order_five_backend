...
export declare class WalletRequestService {
    private readonly WalletRequestModel;
    constructor(WalletRequestModel: Repository<Wallet_req>);
    getAllPages(user_id: any, page: number, pageSize: number, search: string, status: string): Promise<{
        totalItems: number;
        data: any[];
        totalPages: number;
        currentPage: number;
