...
export declare class OrderService {
    ...
    getOrderList(page: number, pageSize: number, search: string, user_id: any, status?: string): Promise<{
        status: boolean;
        message: string;
        data: {
            totalItems: number;
    ...
    getOrderCount(user_id: number): Promise<{
        status: boolean;
        message: string;
        data: {
            activeOrders: number;
    ...
    getRecentOrder(user_id: any): Promise<{
        status: boolean;
        message: string;
        data: {
