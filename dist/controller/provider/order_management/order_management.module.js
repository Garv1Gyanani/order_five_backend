...
exports.OrderProviderModule = void 0;
...
let OrderProviderModule = class OrderProviderModule {
};
OrderProviderModule = __decorate([
    (0, common_1.Module)({
        imports: [
            typeorm_1.TypeOrmModule.forFeature([user_schema_1.User, product_schema_1.Product, user_location_schema_1.User_location, notification_schema_1.Notification, product_request_schema_1.ProductRequest, rating_schema_1.Rating, wishlist_schema_1.ProviderWishlist, order_schema_1.Order, wallet_req_schema_1.Wallet_req, setting_schema_1.Setting]),
...
exports.OrderProviderModule = OrderProviderModule;
